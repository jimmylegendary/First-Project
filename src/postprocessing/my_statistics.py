...
def cal_delong_test(args, classifier_list, train_results) -> pd.DataFrame:
    """(statistics)
    ...
    for clf_1, clf_2 in itertools.combinations(classifier_list, 2):
        real = train_results[clf_1].reals[0]
        clf_1_prob = train_results[clf_1].probs[0]
        clf_2_prob = train_results[clf_2].probs[0]
